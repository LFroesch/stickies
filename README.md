...
```powershell
irm https://raw.githubusercontent.com/LFroesch/stickies/main/install.ps1 | iex
```

Direct installers: [`install.sh`](https://raw.githubusercontent.com/LFroesch/stickies/main/install.sh), [`install.ps1`](https://raw.githubusercontent.com/LFroesch/stickies/main/install.ps1)
